    ...
    return (
        <View className=" px-8 pt-8 flex-1">
            ...
            <ScrollView>
                ...
                <Text className="text-xl">2. TRATAMENTO DE DADOS PESSOAIS</Text>

                <Text className="text-xl">  2.1. Condições de licitude</Text>

                <Text>Para proceder ao tratamento dos seus dados pessoais nos termos do Regulamento (UE) 2016/679 do Parlamento Europeu e do Conselho, de 27 de abril de 2016 relativo à proteção das pessoas singulares no que diz respeito ao tratamento de dados pessoais e à livre circulação desses dados e que revoga a Diretiva 95/46/CE (“RGPD”), a MdP deve atuar com base numa condição de licitude. Esta condição pode ser:
                ...
                <Text className="text-xl">  2.2. Finalidades</Text>
                ...
                <Text className="text-xl">      2.2.1. Recrutamento</Text>

                <Text>A MdP procede ao tratamento de dados pessoais sempre que os respetivos titulares submetem candidaturas no âmbito de um processo de recrutamento.
                </Text>
                <Text className="text-xl">      2.2.2. Gestão de reclamações</Text>
                <Text>
                ...
                <Text className="text-xl">      2.2.3. Gestão de autos de contraordenação</Text>

                <Text>A MdP procede ao tratamento dos seus dados pessoais sempre que cometa uma infração. Este tratamento é efetuado em virtude de uma obrigação legal e com base num interesse legítimo da MdP.
                </Text>
                <Text className="text-xl">      2.2.4. Videovigilância</Text>

                <Text>As instalações da MdP tem câmaras de videovigilância em alguns locais, cujas imagens trata ao abrigo de interesse legítimo na proteção de pessoas e bens. As imagens captadas apenas podem ser transmitidas no âmbito da lei processual penal, sem prejuízo do direito de acesso que assiste aos titulares dos dados.
                ...
                <Text className="text-xl">      2.2.5. Gestão de fornecedores, prestadores de serviço e empreiteiros</Text>
                ...
                <Text className="text-xl">      2.2.6. Gestão de colaboradores externos</Text>

                <Text>A MdP procede ao tratamento de dados pessoais de colaboradores de algumas entidades que lhe prestam serviços ao abrigo dos procedimentos previstos no Código dos Contratos Públicos, com base num interesse legítimo na proteção de pessoas e bens e para cumprimento de obrigações legais.
                </Text>
                <Text className="text-xl">      2.2.7. Atendimento ao Público</Text>
                <Text>
                ...
                <Text className="text-xl">  2.3. Períodos de conservação</Text>
                <Text>
                ...
                <Text className="text-xl">  2.4. Destinatários dos seus dados pessoais</Text>
                <Text>
                ...
                <Text className="text-xl">  2.5. Exercício de direitos pelos titulares dos dados</Text>

                <Text className="text-xl">      2.5.1. Direito de acesso</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.2. Direito de retificação</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.3. Direito ao apagamento</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.4. Direito à limitação do tratamento</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.5. Direito de portabilidade</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.6. Direito de oposição</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.7. Direito a retirar o seu consentimento</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.8. Direito de não ficar sujeito a decisões individuais automatizadas</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.9. Direito de apresentar reclamações junto da autoridade de controlo</Text>
                <Text>
                ...
                <Text className="text-xl">      2.5.10. Como pode exercer os seus direitos</Text>
                <Text>Pode exercer os seus direitos através dos seguintes canais:
                ...
                <Text className="text-xl">  2.6. Encarregado da Proteção de Dados</Text>
                <Text>
